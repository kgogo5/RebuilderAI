  ...
  return (
    <Section>
      <HalfBox>
        <TextComponent
          className="labeling"
          title={t("service.labeling.text1")}
          description={[
            t("service.labeling.text2"),
            t("service.labeling.text3"),
            t("service.labeling.text4"),
          ]}
        />
        <div className="inner">
          <VideoArea>
          ...
          <span className="videoText">{t("service.labeling.video")}</span>
        </div>
      </HalfBox>
    </Section>
  );
