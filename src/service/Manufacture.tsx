    ...
    <Section>
      <HalfBox>
        <TextComponent
          ...
          subtitle={t("service.manufacture.text1")}
          title={t("service.manufacture.text2")}
          description={[
            t("service.manufacture.text3"),
            t("service.manufacture.text4"),
          ]}
        />
        <VideoArea>
          <ReactPlayer
            ...
            url={
              i18n.language === "en"
                ? "/explore_video_en.mp4"
                : "/explore_video_ko.mp4"
            }
            muted
            playing={isPlaying}
            volume={0}
